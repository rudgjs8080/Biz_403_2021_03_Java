...
public class NumberServiceV1A {
	 ...
	 * 
	 * primitive type 중에 숫자형 인 경우는 0을
	...
	public Integer inputNum() {
		...
		if(num2 % 3 == 0) {
			 ...
			 * 		Integer 형이다
			 * 그런데 여기에서 return 하는 num2변수의 type은
			 * 		int 형이다
			 * 별다른 문제를 일으키지는 않지만
			 * 실제 코드가 작동될 때는
