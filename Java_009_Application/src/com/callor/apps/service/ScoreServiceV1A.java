...
public class ScoreServiceV1A {
	...
	// 매우 자주 만나는 Exception
	// 클래스를 사용하여 객체를 "선언"만 아직 사용할 준비가 되어있지 않다
