 ...
 * 모두 파일로 제공하고 필요에 따라 import 하여 사용할 수 있도록
 * 하고 있다
 * 
 * import java.util.Random;
 * 지금부터 controller_06 클래스에서
 * java.util 패키지의 Random 클래스 라는
 * 도구를 사용하여 코딩을 하겠다 라는 선언이다
 * 
...
public class Controller_06 {
	...
	public static void main(String[] args) {
		 ...
		 * 	Integer는 키워드가 아닌 클래스이다
		 * 
		 * 키워드는 java가 처음 탄생될때부터 만들어진 명령어
		 * 클래스는 키워드 처럼 사용이 되지만 
		 * 		java가 탄생하고 이후에 필요에 의해 추가, 확장된 명령
		 */
		Random rnd = null; // 선언
		rnd = new Random(); // 초기화
		...
		// String, Integer, Random 은 대문자로 시작한다 => class 라는 의미
		// int 는 그렇지 않다 구별해야한다. keyword 라는 의미
		
		/*
		 * wrapper 클래스 : 클래스이지만 변수선언처럼 사용할 수 있는 도구들
		 * Integer, Long, Float, Double, Boolean, Charactor 들은
		 * 
		 * int, long, float, double, boolean, char 키워드에 확장된 기능을 할 수 있도록
		 * 만들어진 class 이다
		 * 
