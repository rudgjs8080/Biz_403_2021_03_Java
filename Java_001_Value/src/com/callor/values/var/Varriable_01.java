...
public class Varriable_01 {
	public static void main(String[] args) {
		 ...
		 * 9. println() 덧셈결과가 보관된 기억장소를 찾아가서 보관된 값을 
		 * 		가져와서 system.out 한테 보낸다
		 * 10. system.out 은 운영체제(Windows)에게 
		 * 결과를 Console(cmd창)에 출력해달라고 요청한다
		 ...
		 * 어떤 값을 보관을 하기 위해서 지정한 기억장치를 변수라고 한다
		 * 
		 */
	}
