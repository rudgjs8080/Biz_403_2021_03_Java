...
public class App_01A {
	...
	public static void main(String[] args) {
		...
		// for() 반복문이 모두 완료되었거나 중간에 break 만나서 중단되었거나 한 경우
		
		// setting 되거나 그렇지 않은 경우를 판단하여 결과를 출력하기
		if(notPrime) {
			// notPrime == true 이면 소수가 아닌 경우다
			System.out.println(num2 + " 은(는) 소수가 아님");
		} else {
			System.out.println(num2 + " 은(는) 소수임");
		}
		 ...
		 *  
		 *  논리적인 오류를 최소화 하기 우하여 비교연산자를 1개만 사용하여
